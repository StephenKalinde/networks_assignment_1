...
public class Client  {
    ...
    /*
     * To use in the concle mode use one of the following methods
     * > java Client
     * > java Client username
     * > java Client username portNumber
     * > java Client username portNumber serverAddress
     * at the console prompt
     * If the portNumber is not specified 1696 is used
     * If the serverAddress is not specified "localHost" is used
     * If the username is not specified "Anonymous" is used
     * > java Client
     * is equivalent to
     * > java Client Anonymous 1696 localhost
     * are eqquivalent
     *
    ...
    // a class that will wait for the message from the server and display in text box
    ...
    public static void main(String[] args) {
        ...
        //if fails we will need to start again 
        if(!client.start())
            return;
